...
import { attachImageSchema, attachImageToPost, createBlogDraft, createBlogDraftSchema, createBlogFromRawUpdate, createFromRawSchema, getBlogPost, getPostSchema, listRecentPosts, listRecentSchema, publishBlogPost, publishSchema, scheduleBlogPost, scheduleSchema, searchPosts, searchPostsSchema, textResult, uploadBlogImage, uploadImageSchema, } from './tools.js';
const server = new McpServer({
    name: 'agri-updates',
    version: '0.1.0',
});
server.registerTool('list_recent_posts', {
...
server.registerTool('create_blog_draft', {
...
server.registerTool('create_blog_from_raw_update', {
...
server.registerTool('schedule_blog_post', {
