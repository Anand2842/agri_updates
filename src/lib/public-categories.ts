...
export function getCategoryAccentClasses(accent: CategoryAccent) {
    const theme = {
        ...
        forest: {
            chip: 'border-emerald-200 bg-emerald-50 text-emerald-800 font-medium',
            text: 'text-emerald-900',
            muted: 'text-emerald-700',
            rule: 'bg-emerald-600',
            panel: 'border-emerald-100 bg-emerald-50/40 hover:border-emerald-200',
            button: 'bg-emerald-700 text-white hover:bg-emerald-800',
        },
        sage: {
            chip: 'border-teal-200 bg-teal-50 text-teal-800 font-medium',
            text: 'text-teal-900',
            muted: 'text-teal-700',
            rule: 'bg-teal-600',
            panel: 'border-teal-100 bg-teal-50/40 hover:border-teal-200',
            button: 'bg-teal-700 text-white hover:bg-teal-800',
        },
        amber: {
            chip: 'border-amber-200 bg-amber-50 text-amber-900 font-medium',
            text: 'text-amber-900',
            muted: 'text-amber-700',
            rule: 'bg-amber-500',
            panel: 'border-amber-100 bg-amber-50/40 hover:border-amber-200',
            button: 'bg-amber-600 text-white hover:bg-amber-700',
        },
        vermilion: {
            chip: 'border-rose-200 bg-rose-50 text-rose-800 font-medium',
            text: 'text-rose-950',
            muted: 'text-rose-700',
            rule: 'bg-rose-600',
            panel: 'border-rose-100 bg-rose-50/50 hover:border-rose-200',
